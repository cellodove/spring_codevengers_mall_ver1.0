		...
		<div id="container_box">
			<section id="content">
				<form role="form" method="post">
					<input type="hidden" name="gdsNum" value="${view.item_num}" />
				</form>
			
				<div class="goods">
				
				<div class="goodsImg">
					<img src="${view.item_picture}" class="oriImg" />
				</div>
				
				<div class="goodsInfo">
				<p class="gdsName">
					<span>상품명</span>${view.item_name}
				</p>
				<p class="cateName">
				 <span>카테고리</span>${view.cateName}
				</p>
				<p class="gdsPrice">
					<span>가격 </span><fmt:formatNumber pattern="###,###,###" value="${view.item_price}" /> 원
				</p>
				
				<p class="gdsStock">
 					<span>재고 </span><fmt:formatNumber pattern="###,###,###" value="${view.item_allnumber}" /> EA
  				</p>
				
				<p class="cartStock">
 					<span>구입 수량</span>
 					<button type="button" class="plus">+</button>
 					<input type="number" class="numBox" min="1" max="${view.item_allnumber}" value="1" readonly="readonly"/>
 					...
 					<script>
 					 $(".plus").click(function(){
  					 ...
  					 if(plusNum >= ${view.item_allnumber}) {
   					 $(".numBox").val(num);
   					} else {
    					$(".numBox").val(plusNum);          
   					}
   ...
   success : function(){
	  ...
	  $("#repCon").val("");
 					...
 					<section class="replyList">
  						...
  						<li>
      						<div class="userInfo">
       							<span class="userName">${reply.mem_name}</span>
       							<span class="date"><fmt:formatDate value="${reply.rbrd_date}" pattern="yyyy-MM-dd" /></span>
     						</div>
